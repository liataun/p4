...
@section('content')
    ...
    <div class='row justify-content-md-center'>
        <p class='text-info text-center'>This site allows users to create multi-line posts and select an artwork to associate with each. All posts are shown to all users. Some pre-generated Artwork tags and User reactions are displayed, but cannot be changed. You can view a list of available artwork images on the <a href='/art'>Artwork</a> page.</p>
    </div>
    @if(Auth::check())
        <div class='row justify-content-md-center'>
            <h5>User Info</h5>
